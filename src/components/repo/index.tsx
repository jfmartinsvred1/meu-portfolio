...
const Repo = ({ repo,showMoreRepo }: RepoProps) => {
    return (
        <>
            <div onClick={()=>{showMoreRepo(repo)}} className="bg-dark shadow p-3 mb-5 gap-4 rounded repo d-flex flex-column text-light justify-content-center align-items-center">
